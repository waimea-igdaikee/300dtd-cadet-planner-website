...
2. You must use appropriate complex tools and techniques, for example:
   ...
   - [x] You have **integrated original media assets** into your work, as needed (favicon)
...
2. You have used efficient tools and techniques in the web site's production:
   ...
   - [x] You have **optimised media assets** (e.g. image sizing) (not needed beyond ensuring favicon isn't huge)
